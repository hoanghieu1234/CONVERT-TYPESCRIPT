...
const Cart = () => {
  const idUser: any = JSON.parse(localStorage.getItem("userLogin") as string).data?._id;
  console.log("idUser", idUser)

  const [cartItems, setCartItems] = useState<CartItem[]>([]);

  const [deleteItemId, setDeleteItemId] = useState<string | null>(null); // Store the item ID to delete
